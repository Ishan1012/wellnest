    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
          <MagnifyingGlassIcon className="h-5 w-5 text-slate-505 text-slate-500" />
        </div>
        <input
          type="text"
          value={searchQuery}
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex px-2.5 py-1 rounded-full text-xs font-semibold uppercase tracking-wider ${
                        doctor.status === 'active' 
                          ...
                          : 'bg-red-100 text-red-805 text-red-800 border border-red-200/20'
                      }`}>
                        {doctor.status || 'active'}
                      </span>
                    </td>
            ...
            <form onSubmit={handleAddDoctor} className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-slate-200 rounded-lg py-2.5 px-3.5 text-slate-800 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-emerald-600 text-sm shadow-sm"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    placeholder="e.g. 5"
                    className="w-full bg-white border border-slate-200 rounded-lg py-2.5 px-3.5 text-slate-805 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-emerald-600 text-sm shadow-sm"
                  />
                </div>
              </div>
              ...
              <div className="flex gap-4 pt-4 border-t border-slate-100 bg-slate-50/20">
                <button
                  type="button"
                  onClick={() => setModalOpen(false)}
                  className="flex-1 cursor-pointer py-2.5 rounded-lg border border-slate-200 text-slate-600 hover:text-slate-900 hover:bg-slate-50 transition text-sm font-semibold"
                >
                  Cancel
                </button>
                <button
